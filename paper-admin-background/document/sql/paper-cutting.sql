...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='买家信息表';

-- 正在导出表  paper-cutting.buyer_info 的数据：~0 rows (大约)
INSERT INTO `buyer_info` (`buyer_id`, `buyer_name`, `buyer_password`, `buyer_hobby`, `buyer_autograph`, `pic_url`,
                          `create_time`, `update_time`, `del_flag`)
VALUES (1782381108064657409, 'admin', '$2a$10$52VDy3n3u4VbFDRHfG3O.O7RmLao/0JGf2IuPvJETXTSkFVMfmKdC', NULL, NULL, NULL,
        '2024-04-22 12:09:05', '2024-04-22 12:09:05', b'0'),
       (1782381134824316929, 'admi', '$2a$10$JiNm1L1dWMo.mlAXDCa4FODWeWDNJclTRgisLKYMkwbdZmjGsKcpC', NULL, NULL, NULL,
        '2024-04-22 12:09:12', '2024-04-22 12:09:12', b'0'),
       (1782381148883623938, 'adm', '$2a$10$b9g05KUzDqLgTWv9jGS6GOse6NIvXSCEM7KUYITZ1yuLAXtJKA7lC', NULL, NULL, NULL,
        '2024-04-22 12:09:15', '2024-04-22 12:09:15', b'0'),
       (1782381159910449153, 'ad', '$2a$10$KyscoVDTOiMp/Lv7drBYuebBi5K5sgFMcGRrxWZgVR0kNSsjoOrl2', NULL, NULL, NULL,
        '2024-04-22 12:09:18', '2024-04-22 12:09:18', b'0'),
       (1782381167762186242, 'a', '$2a$10$uHbmjgOXZcH/sgl3O78prucUEVdRouTD/9HHZRSejm2o5ZRjcDRlq', NULL, NULL, NULL,
        '2024-04-22 12:09:20', '2024-04-22 12:09:20', b'0'),
       (1782381711926992898, 'a1155', '$2a$10$5KkTkZixHRVDiv6jHHPouuqtJb2TdxXMx2MFY50FCxDmxtSf7JsbC', NULL, NULL, NULL,
        '2024-04-22 12:11:29', '2024-04-22 12:11:29', b'0'),
       (1782381753219915778, 'a11556', '$2a$10$WLiV4W/PeqtXXJOMmRrRSOzzcU/eWHxooicVhE0NgfmBWP6oS.J5W', NULL, NULL, NULL,
        '2024-04-22 12:11:39', '2024-04-22 12:11:39', b'0'),
       (1782381793145495553, 'a11557', '$2a$10$5/JsFJt/GZ6eGPSDZ6AOq.i/.Kg2J0U12jAIeHsnHzE9fpEvKmAlu', NULL, NULL, NULL,
        '2024-04-22 12:11:49', '2024-04-22 12:11:49', b'0'),
       (1782381820895010817, 'a11558', '$2a$10$G3/5P/9uRmMBud6RH40s0OSC.sZJ9VVcgE8E.L0YjqoGb88X.38RW', NULL, NULL, NULL,
        '2024-04-22 12:11:55', '2024-04-22 12:11:55', b'0');
...
(
  ...
  AUTO_INCREMENT = 2
  DEFAULT CHARSET = utf8mb4 COMMENT ='每日签到表';
...
(
    ...
    `goods_category_name`  varchar(50) CHARACTER SET utf8mb4 NOT NULL COMMENT '第一类别名称',
    `category_superior_id` tinyint unsigned                  NOT NULL DEFAULT '0' COMMENT '0即为上级分类',
    PRIMARY KEY (`goods_category_id`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 13
  DEFAULT CHARSET = utf8mb4 COMMENT ='商品第一类别表';

-- 正在导出表  paper-cutting.goods_category 的数据：~10 rows (大约)
INSERT INTO `goods_category` (`goods_category_id`, `goods_category_name`, `category_superior_id`)
VALUES (1, '剪纸画', 0),
       (2, '生肖', 0),
       (3, '人像', 0),
       (4, '窗花', 0),
...
INSERT INTO `goods_info` (`goods_id`, `goods_category_id`, `shop_id`, `goods_name`, `goods_introduction`, `pic_url`,
                          `price`, `promotion_price`, `sold_number`, `total_number`, `create_time`, `update_time`,
                          `del_flag`)
VALUES (1, 12, 1, '手工剪纸十二生肖', '手工剪纸十二生肖是我国.....', 'abc', 20.00, 10.00, 15, 78, '2024-04-16 07:13:24',
        '2024-04-22 04:43:58', b'0');
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='近期浏览商品';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='店铺关注表';
...
(
  ...
  AUTO_INCREMENT = 722354180
  DEFAULT CHARSET = utf8mb4 COMMENT ='店铺信息表';

-- 正在导出表  paper-cutting.shop_info 的数据：~2 rows (大约)
INSERT INTO `shop_info` (`shop_id`, `shop_name`, `pic_url`, `create_time`, `update_time`, `del_flag`)
VALUES (1, '姿色纸缘', 'cdf', '2024-04-16 07:26:15', '2024-04-16 07:26:16', b'0'),
...
INSERT INTO `ums_admin` (`id`, `username`, `password`, `icon`, `email`, `nick_name`, `note`, `create_time`,
                         `login_time`, `status`)
VALUES (1, '', '$2a$10$NZ5o7r2E.ayT2ZoxgjlI.eJ6OEYqjH7INR/F.mXDbjZJi9HF0YCVG', '头像', '邮箱', '昵称', '备注信息',
        '2018-09-29 13:55:30', '2018-09-29 13:55:39', 0),
       (3, 'admin', '$2a$10$.E1FokumK5GIXWgKlg.Hc.i/0/2.qdAwYFL1zc5QHdyzpXOr38RZO',
       ...
       (4, 'macro', '$2a$10$Bx4jZPR7GhEpIQfefDQtVeS58GfT5n6mxs/b4nLLK65eMFa16topa',
       ...
       (6, 'productAdmin', '$2a$10$6/.J.p.6Bhn7ic4GfoB5D.pGd7xSiD1a9M6ht6yO0fxzlKJPjRAGm',
       ...
       (7, 'orderAdmin', '$2a$10$UqEhA9UZXjHHA3B.L9wNG.6aerrBjC6WHTtbv1FdvYPUI.7lkL6E.',
       ...
       (8, 'test123', '$2a$10$M1qJguEzwoAN0la7PB8UO.HOGe1xZGku7xw1iTaUUpY0ZVRCxrxoO', 'string', 'abc@qq.com', 'string',
        'string', '2022-08-07 14:45:42', NULL, 1),
       (9, 'test256', '$2a$10$kTMBrt8mkXcO8T4eHThFWOf3KuNK6tqevkiAf4YbtXtaCJ6ocYkJa', 'string', 'abc@qq.com', 'string',
        'string', '2022-08-07 14:52:57', NULL, 1),
       (10, 'test1267', '$2a$10$VUywDhXVPY13YZxMD/uPWeDqkzSozN7o8u/3MX6sBig2NK2VaTJZ2', NULL, 'test1267@qq.com',
...
(
  ...
  AUTO_INCREMENT = 417
  DEFAULT CHARSET = utf8mb3
  ROW_FORMAT = DYNAMIC COMMENT ='后台用户登录日志表';

-- 正在导出表  paper-cutting.ums_admin_login_log 的数据：~414 rows (大约)
INSERT INTO `ums_admin_login_log` (`id`, `admin_id`, `create_time`, `ip`, `address`, `user_agent`)
...
(
  ...
  AUTO_INCREMENT = 8
  DEFAULT CHARSET = utf8mb3
  ROW_FORMAT = DYNAMIC COMMENT ='资源分类表';
...
(
  ...
  AUTO_INCREMENT = 127
  DEFAULT CHARSET = utf8mb3
  ROW_FORMAT = DYNAMIC COMMENT ='后台角色菜单关系表';
...
(
  ...
  AUTO_INCREMENT = 249
  DEFAULT CHARSET = utf8mb3
  ROW_FORMAT = DYNAMIC COMMENT ='后台角色资源关系表';
