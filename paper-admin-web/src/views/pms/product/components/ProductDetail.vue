    ...
    created () {
        if (this.isEdit) {
            getProduct(this.$route.query.id).then(response => {
                ...
                this.productParam.name = response.data.goodsName;
                this.productParam.introduction = response.data.goodsIntroduction;
                this.productParam.shopId = response.data.shopInfo.shopId;
                this.productParam.shopName = response.data.shopInfo.shopName;
