            ...
            <div style="margin-top: 15px">
                <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
                    ...
                    <el-form-item label="商品品牌：">
                        <el-select v-model="listQuery.shopId" placeholder="请选择品牌" clearable>
                            <el-option
        ...
        <div class="table-container">
            ...
            >
                ...
                <el-table-column label="商品图片" width="120" align="center">
                    <template slot-scope="scope"><img style="height: 80px" :src="scope.row.picUrl" alt=""></template>
                </el-table-column>
                <el-table-column label="商品名称" align="center">
                    <template slot-scope="scope">
                        <p>{{ scope.row.goodsName }}</p>
                        <p>品牌：{{ scope.row.shopInfo && scope.row.shopInfo.shopName }}</p>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="库存" width="100" align="center">
                    <template slot-scope="scope">{{ scope.row.soldNumber }}</template>
                </el-table-column>
    ...
    watch: {
        selectProductCateValue: function (newValue) {
            if (newValue != null && newValue.length === 2) {
                this.listQuery.goodsCategoryId = newValue[1];
            } else {
                this.listQuery.goodsCategoryId = null;
            }
    ...
    methods: {
        ...
        getBrandList () {
            fetchBrandList({ pageNum: 1, pageSize: 100 }).then(response => {
                console.log('fetchBrandList-------', response.data);
                this.brandOptions = [];
        ...
        getProductCateList () {
            fetchListWithChildren().then(response => {
                console.log('fetchListWithChildren-------', response.data);
        ...
        handleUpdateProduct (index, row) {
            this.$router.push({ path: '/pms/updateProduct', query: { id: row.goodsId } });
        },
        ...
        updateRecommendStatus (recommendStatus, ids) {
            ...
            updateRecommendStatus(ids).then(response => {
                this.$message({
                    message: '修改成功',
                    type: 'success',
                    duration: 1000
        ...
        updateDelete (ids) {
            ...
            updateDelete(params).then(response => {
                this.$message({
                    message: '删除成功',
                    type: 'success',
                    duration: 1000
