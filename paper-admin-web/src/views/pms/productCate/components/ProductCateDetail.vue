<template>
    <el-card class="form-container" shadow="never">
        <el-form
            ...
            label-width="150px"
        >
            <el-form-item label="分类名称：" prop="goodCategoryName">
                <el-input v-model="productCate.goodCategoryName"/>
            </el-form-item>
            <el-form-item label="上级分类：">
                <el-select
                    v-model="productCate.categorySuperiorId"
                    placeholder="请选择分类"
                >
                    <el-option
                        v-for="item in selectProductCateList"
                        :key="item.goodsCategoryId"
                        :label="item.goodCategoryName"
            ...
            <el-form-item label="分类图标：">
                <single-upload v-model="productCate.picUrl"/>
            </el-form-item>
    ...
    methods: {
        getSelectProductCateList () {
            fetchList(0, { pageSize: 100, pageNum: 1 }).then(response => {
                ...
                this.selectProductCateList.unshift({ id: 0, goodCategoryName: '无上级分类' });
            });
        },
